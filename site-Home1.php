...
<div id="carouselExampleIndicators" class="carousel slide h-25" data-bs-ride="true">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="/img/materias.jpg" class="img-fluid h-25" alt="materias">
    </div>
  </div>
...
<div class="row row-cols-1 row-cols-md-3 g-4">
  ...
  <div class="col">
    <div class="card h-100">
      <img src="/img/materias.jpg" class="card-img-top h-50" alt="materias">
      <div class="card-body">
        <h5 class="card-title">Materias</h5>
        <p class="card-text">Acesse as materias dos cursos da PUC Campinas.</p>
        <a href="#" class="btn btn-primary">Lista de Materias</a>
      </div>
      <div class="card-footer">
        <small class="text-muted">Last updated 3 mins ago</small>
      </div>
